...
| 黑客赛博朋克个人主页 | Vue 3 + Vite | `geek-homepage/` | CYBER GEEK 个人主页:`GeekHero` glitch + 打字机 + CRT 屏、粒子网络背景、四向滚动光带、霓虹像素拍立得、双层擦除按钮等 11 组件 + 3 composables;内含蒸馏动态效果 | `cd geek-homepage && npm install && npm run dev` |
...
> 效果配方见 `references/dynamic-effects.md` 与 `references/background-fluid-grid.md`;个人主页内置的动态效果是 `dynamic-effects.md` 的完整 Vue 实现。
>
